...
You know the cliches: it's a door into another world, a window into <Def content='tester'>another mind</Def>, an escape from the world you live in. Even in spite of the fact that these are cliches — and we _should_ be wary of cliche! — there is truth to these statements.
...
<Feed user={user} path={path} options={[1, 2, 3]} withOther={true} id="1" />
